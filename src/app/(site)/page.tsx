...
const cardHeader = (index: number, testimonial: { name: string; message: string; }) => {
  return (
...
const cardContent = (testimonial: { name: string; message: string; }) => {
  return (
...
const pricingCardHeader = (card: typeof PRICING_CARDS[0]) => {
  return (
...
const pricingCardFooter = (card: typeof PRICING_CARDS[0]) => {
  return (
...
const pricingCardContent = (card: typeof PRICING_CARDS[0]) => {
  return (
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10">
          {PRICING_CARDS.map(card => (
            <CustomCard
              ...
              cardHeader={pricingCardHeader(card)}
              cardContent={pricingCardContent(card)}
              cardFooter={pricingCardFooter(card)}
            >
